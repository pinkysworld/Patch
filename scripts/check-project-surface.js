...
requireAll('current native facade', current, [
  ...
  "PATCH_CURRENT_NATIVE_RUNTIME_VERSION = '1.9'",
  'PATCH_CURRENT_NATIVE_GUI_IR_VERSION = PATCH_NATIVE_GUI_IR_V18_VERSION',
  'PATCH_CURRENT_NATIVE_PAYLOAD_VERSION = PATCH_SEALED_NATIVE_GUI_IMAGELIST_VERSION',
...
requireAll('Native GUI IR 1.8', ir18, [
  "PATCH_NATIVE_GUI_IR_V18_VERSION = '1.8'",
  'buildNativeGuiIRV18','validateNativeGuiIRV18'
]);
const sealed18 = read('src/sealed-native-gui-v18.js');
requireAll('sealed native payload v18', sealed18, ['sealNativeGuiRuntimeV18','PATCH_SEALED_NATIVE_GUI_IMAGELIST_VERSION']);

const offline = read('.github/workflows/offline-compiler.yml');
requireAll('offline compiler v0.2 workflow', offline, [
  'native-runtime\\win32-sealed-gui-v19.cpp','native-runtime/gtk-sealed-gui-v19.cpp','native-runtime/appkit-sealed-gui-v19.mm',
  'examples/chrome-window.patch','examples/shape-window.patch','examples/paintbox-window.patch','examples/paintbox-image-window.patch','payload v18','offline-compiler-v0.2','Patch Offline Compiler v0.2'
]);
...
requireAll('beta36 site build normalization', siteBuild, [
  ...
  'normalizeCurrentProductSurface','0.2 beta.36+','Native GUI IR 1.8 / payload v18 / runtime v1.9',
...
requireAll('beta36 milestone', beta36, [
  'Patch 0.2.0-beta.36','Native GUI IR: `1.8`','sealed payload: `v18`','desktop runtime: `v1.9`','offline compiler line: `offline-compiler-v0.2`',
...
requireAll('Pages current runtime acquisition', pages, ['native-win32-runtime-v1.9','native-macos-runtime-v1.9','native-linux-runtime-v1.9']);
...
console.log('Patch project surface is coherent for beta.36 / IR 1.8 / payload v18 / runtime v1.9 / offline compiler v0.2.');
