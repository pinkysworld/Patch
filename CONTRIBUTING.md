...
Read [SECURITY.md](SECURITY.md) before changing parsers/evaluators, persistent mutation paths, capability checking, generated HTML/native code, process invocation, remote-build token handling, certificate/evidence boundaries or release/update mechanisms.
