...
requireText(index, 'Native GUI IR 1.6', 'Studio current native status');
requireText(index, 'payload v16', 'Studio current native status');
requireText(index, 'runtime v1.7', 'Studio current native status');
...
requireText(current, "PATCH_CURRENT_NATIVE_CONTRACT_ID = 'native-gui-1.6/payload-16/runtime-1.7'", 'current native facade');
requireText(current, "PATCH_CURRENT_NATIVE_RUNTIME_VERSION = '1.7'", 'current native facade');
...
requireText(downloads, 'Native GUI IR <strong>1.6</strong>', 'Downloads current IR');
requireText(downloads, 'payload <strong>v16</strong>', 'Downloads current payload');
requireText(downloads, 'runtime <strong>v1.7</strong>', 'Downloads current runtime');
...
console.log('Patch Studio frozen Native GUI IR 1.2 / payload v12 / runtime v1.3 compatibility surface validated separately behind the current IR 1.6 / payload v16 / runtime v1.7 facade.');
