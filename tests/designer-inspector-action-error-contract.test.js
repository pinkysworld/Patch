...
test('migrated Form and Table actions remain part of the Designer Workspace and hosted bundle', () => {
  const workspace = fs.readFileSync('web/designer-workspace.js', 'utf8');
  const buildSite = fs.readFileSync('scripts/build-site.js', 'utf8');
  for (const module of ['designer-form-duplicate.js', 'designer-form-delete.js', 'designer-table-actions.js']) {
