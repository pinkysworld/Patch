import { validateWindowBuild, validateWindowRuntimeSupport } from './window-build.js?v=868f0784ca7f3972';
...
export function buildStandaloneWindowWebApp(compiled, name) {
  ...
  validateWindowRuntimeSupport(compiled, { allowTree: true, allowSlider: true, allowPaintBox: true, allowImageList: true });
