...
test('browser package seals current Native GUI IR 1.6 payload v16 into one Linux ELF executable', () => {
...
test('Studio defaults Linux Window downloads to native GTK runtime v1.7 sealing without token', () => {
  ...
  assert.ok(studio.includes('Linux native GTK runtime v1.7 app downloaded · no token · no Electron'));
