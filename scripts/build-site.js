...
const SITE_WEB_MODULE_FILES = [
  ...
  'playground.js','forms-designer.js','designer-selection.js','designer-core-selection.js','table-stage1.js','tree-designer.js','designer-workspace.js','designer-data-editor.js','designer-structural-keyboard.js','designer-tabs-nested.js','designer-ux.js','designer-toolbox.js','form-designer-workflow.js','designer-alignment.js','designer-alignment-guides.js','form-window-resize.js',
  'studio-dom-sync.js','studio-diagnostics.js','studio-accessibility.js','sw.js'
];

SITE_HTML_FILES.splice(3, 0, 'downloads.html');
SITE_WEB_STATIC_FILES.splice(10, 0, 'designer-multiselect.css', 'designer-responsive-layout.css', 'beta35-studio.css', 'studio-outline.css');
SITE_WEB_MODULE_FILES.splice(6, 0, 'beta35-studio.js', 'studio-outline.js');
SITE_WEB_MODULE_FILES.splice(22, 0, 'designer-multiselect.js', 'designer-layout-policy.js', 'designer-responsive-layout.js');
