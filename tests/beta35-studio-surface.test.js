...
test('beta35 multi-select workflow remains visible after Current Ready v1.10 promotion', () => {
  ...
  assert.match(index, /payload v17\/runtime v1\.8 remains an explicit compatibility option/i);
