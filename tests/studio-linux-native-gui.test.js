...
test('browser package seals current Native GUI IR 1.5 payload v15 into one Linux ELF executable', () => {
...
test('Studio defaults Linux Window downloads to native GTK runtime v1.6 sealing without token', () => {
  ...
  assert.ok(studio.includes('Linux native GTK runtime v1.6 app downloaded · no token · no Electron'));
