...
/**
 * Generate Lean checks for concrete inter-recipe parameter binding. This first
 * production-connected slice deliberately certifies variable pass-through
 * arguments only (for example `do add_points(bonus)`). Root-program calls and
 * richer arithmetic stay outside the certificate until their encodings are
 * added explicitly.
 */
