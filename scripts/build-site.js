...
const SITE_SRC_FILES = [
  ...
  'c99.js','webapp.js','window-webapp.js','window-web-accessibility.js','window-web-paintbox.js','window-build.js','menu-shortcut.js','window-events.js','designer.js','designer-shape.js','designer-paintbox.js','component-registry.js','designer-menu.js','designer-panel.js','designer-data.js','designer-tabs-nested.js','form-layout.js','window-layout-policy.js','studio-project.js','studio-resources.js','studio-resource-picture-placement.js','studio-outline-model.js','studio-diagnostics.js','studio-design-model.js','studio-design-cache.js','studio-form-materialization.js',
