...
import {
  PATCH_SEALED_NATIVE_GUI_IMAGELIST_VERSION,
...
export const PATCH_CURRENT_NATIVE_PAYLOAD_VERSION = PATCH_SEALED_NATIVE_GUI_IMAGELIST_VERSION;
...
export const inspectCurrentNativeGuiImageLists = inspectNativeGuiImageListsV18;
...
export const currentNativeHasImageList = hasNativeImageList;
...
export function sealCurrentNativeGuiRuntime(runtimeBytes, nativeGui, options = {}) {
  ...
  return sealNativeGuiRuntimeV18(runtimeBytes, resolved.ir, options);
}
