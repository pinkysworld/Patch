...
requireText(index, 'payload v19', 'Studio current native status');
requireText(index, 'runtime v1.10', 'Studio current native status');
...
requireText(nativeBuild, 'allowImageList: true', 'browser current native builder');
...
requireText(current, "PATCH_CURRENT_NATIVE_CONTRACT_ID = 'native-gui-1.9/payload-19/runtime-1.10'", 'current native facade');
requireText(current, "PATCH_CURRENT_NATIVE_RUNTIME_VERSION = '1.10'", 'current native facade');
...
requireText(downloads, 'payload <strong>v19</strong>', 'Downloads current payload');
requireText(downloads, 'runtime <strong>v1.10</strong>', 'Downloads current runtime');
requireText(downloads, 'Native GUI IR 1.7 / payload v17 / runtime v1.8', 'Downloads explicit v17 compatibility line');
