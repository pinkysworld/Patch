...
The current Ready desktop Window product contract is **Native GUI IR 1.7 / sealed payload v17 / native runtime v1.8**. Older versioned contracts remain frozen compatibility and reproducibility lines. Product versioning does not widen the beta.32 Lean assurance claim.
