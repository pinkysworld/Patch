...
test('pre-v18 native GUI reports Button image bindings instead of silently dropping them', () => {
  ...
  assert.match(
    ...
    /line 3: native GUI Button does not transport image app_images\.open\. This is the pre-v18 compatibility reject: ImageList consumers remain fail-closed on desktop native lines before Native GUI IR 1\.8\./
  );
});
