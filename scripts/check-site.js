...
const required = [
  ...
  '_site/src/wasm.js','_site/src/wasm-direct.js','_site/src/c99.js','_site/src/webapp.js','_site/src/designer.js'
];
...
for (const phrase of ['./src/compiler.js','./src/wasm-direct.js','./src/c99.js','native-windows','native-macos','native-linux','native-freebsd','freebsd-c99.yml','compileToC99','workflow_dispatch','source_b64','Window / GUI','downloadArtifact']) requireText('native builder', nativeBuild, phrase);
...
for (const [file, phrases] of [
  ...
  ['_site/src/webapp.js',['buildStandaloneWebApp','WASM_BASE64']]
...
for (const cached of ["'./native-build.js'","'./src/compiler.js'","'./src/formal-source.js'","'./src/source-validation.js'","'./src/wasm-direct.js'","'./src/c99.js'","'./src/webapp.js'"]) requireText('service worker',sw,cached);
