...
test('browser package seals current Native GUI IR 1.8 payload v18 into one Linux ELF executable', () => {
...
test('Studio defaults Linux Window downloads to native GTK runtime v1.9 sealing without token', () => {
  ...
  assert.ok(studio.includes('Linux native GTK runtime v1.9 app downloaded · no token · no Electron'));
