...
when close_button changed:
  ...
  assert.throws(
    ...
    /support 'clicked' on buttons\/menu items\/PictureBox, 'paint' on PaintBox, 'ticked' on Timer, and 'changed' on inputs\/memos\/checkboxes\/combos\/listboxes\/radios\/tables\/trees\/sliders/
  );
});
