...
const CORE = [
  './', './index.html', './style.css', './workspace-layout.css', './designer-inspector.css', './forms-designer.css', './playground.js', './forms-designer.js', './native-build.js', './manifest.webmanifest', './icon.svg',
