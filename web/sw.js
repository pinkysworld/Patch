...
const CORE = [
  ...
  './style.css', './site-navigation.css', './site-pages.css', './studio-accessibility.css', './designer-inspector.css', './forms-designer.css', './designer-multiselect.css', './designer-responsive-layout.css', './form-window-resize.css', './beta35-studio.css', './studio-outline.css', './project-lifecycle.css', './recovery-manager.css', './studio-diagnostics.css',
  './runtime-integrity.js', './native-build.js', './project-lifecycle.js', './project-config-restore.js', './recovery-manager.js',
  './playground.js', './beta35-studio.js', './studio-outline.js', './forms-designer.js', './table-stage1.js', './tree-designer.js', './designer-workspace.js', './designer-alignment.js', './designer-alignment-guides.js', './designer-multiselect.js', './designer-layout-policy.js', './designer-responsive-layout.js', './form-window-resize.js', './studio-dom-sync.js', './studio-diagnostics.js', './studio-accessibility.js', './manifest.webmanifest', './icon.svg',
  ...
  '../src/wasm-direct.js', '../src/c99.js', '../src/webapp.js', '../src/window-webapp.js', '../src/window-web-accessibility.js', '../src/window-build.js', '../src/menu-shortcut.js', '../src/window-events.js', '../src/designer.js', '../src/form-layout.js', '../src/window-layout-policy.js', '../src/studio-project.js', '../src/studio-outline-model.js', '../src/studio-diagnostics.js', '../src/window-compiled.js', '../src/native-gui-ir.js', '../src/native-gui-ir-v08.js', '../src/native-gui-ir-v09.js', '../src/native-gui-ir-v10.js', '../src/native-gui-ir-v11.js', '../src/native-gui-ir-v12.js', '../src/native-tree-backend-adapter.js', '../src/sealed-native-gui.js', '../src/sealed-native-gui-v11.js', '../src/sealed-native-gui-v12.js',
