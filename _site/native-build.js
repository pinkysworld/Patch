...
import { compileToC99 } from './src/c99.js?v=868f0784ca7f3972';
import { validateWindowRuntimeSupport } from './src/window-build.js?v=868f0784ca7f3972';
import { buildCompiledWindowArtifact } from './src/window-compiled.js?v=868f0784ca7f3972';
import {
  PATCH_CURRENT_NATIVE_PAYLOAD_VERSION,
  buildCurrentNativeGuiIR as buildNativeGuiIR,
  sealCurrentNativeGuiRuntime
} from './src/native-current-contract.js?v=868f0784ca7f3972';
import { buildLinuxNativeGuiPackage, buildMacosNativeGuiPackage } from './src/sealed-native-package.js?v=868f0784ca7f3972';
import { buildLocalNativeKit } from './src/local-native-kit.js?v=868f0784ca7f3972';
import { buildPrebuiltNativePackage, prebuiltNativeTemplateUrl } from './src/prebuilt-native.js?v=868f0784ca7f3972';
import { buildPrebuiltCompiledWindowPackage } from './src/prebuilt-window.js?v=868f0784ca7f3972';
import { diagnosticFromError, formatPatchDiagnostic } from './src/diagnostics.js?v=868f0784ca7f3972';
import { getStudioProjectDiagnosticContext, getStudioProjectResources } from './project-lifecycle.js?v=868f0784ca7f3972';
