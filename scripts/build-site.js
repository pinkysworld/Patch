...
const SITE_SRC_FILES = [
  ...
  'c99.js','webapp.js','window-webapp.js','window-web-accessibility.js','window-web-paintbox.js','window-web-splitcontainer.js','window-web-numberedit.js','window-build.js','menu-shortcut.js','window-events.js','designer.js','designer-shape.js','designer-paintbox.js','component-registry.js','designer-menu.js','designer-panel.js','designer-data.js','designer-tabs-nested.js','form-layout.js','window-layout-policy.js','panel-scroll.js','panel-split.js','input-number.js','input-presentation.js','window-input-presentation.js','studio-project.js','studio-resources.js','studio-resource-picture-placement.js','studio-outline-model.js','studio-diagnostics.js','studio-design-model.js','studio-design-cache.js','studio-form-materialization.js',
...
const SITE_WEB_MODULE_FILES = [
  ...
  'playground.js','studio-build-controller.js','studio-run-controller.js','studio-window-renderer.js','studio-design-snapshots.js','studio-runtime-selection-state.js','studio-runtime-render-policy.js','forms-designer.js','designer-selection.js','designer-core-selection.js','slider-stage1.js','table-stage1.js','tree-designer.js','designer-workspace.js','designer-paintbox.js','resource-manager.js','designer-data-editor.js','designer-structural-keyboard.js','designer-tabs-nested.js','designer-structure-ux.js','designer-ux.js','designer-event-inspector.js','designer-focus-order.js','designer-menu-designer.js','designer-panel.js','designer-splitcontainer.js','designer-numberedit.js','designer-ui-namespace.js','designer-toolbox.js','designer-imagelist.js','designer-statusbar.js','form-designer-workflow.js','designer-alignment.js','designer-alignment-guides.js','form-window-resize.js',
