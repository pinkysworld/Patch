...
The product may advance beyond beta.32, but **Beta.32 remains the current formal runtime-correspondence milestone**. Product work such as Current Ready Native GUI IR 1.9 / sealed payload v19 / runtime v1.10, the historical Native GUI IR 1.3 / sealed payload v13 / runtime v1.4 Slider line, the frozen Native GUI IR 1.2 / payload v12 / runtime v1.3 TreeView line, and prototype-free Things does not widen this assurance claim.
