...
The current Ready desktop Window product contract is **Native GUI IR 1.8 / sealed payload v18 / native runtime v1.9**. Older versioned contracts remain frozen compatibility and reproducibility lines. Product versioning does not widen the beta.32 Lean assurance claim.
