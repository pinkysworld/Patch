import { addDesignerControl, listDesignerControls, updateDesignerControl } from './src/designer.js?v=9ad29318e93c7c71';
import { normalizeImageListItemName } from './src/imagelist-control.js?v=9ad29318e93c7c71';
import { studioResourceSourceExpression } from './src/studio-resources.js?v=9ad29318e93c7c71';
import {
...
async function chooseResource() {
  const { chooseStudioImageResource } = await import('./resource-manager.js?v=9ad29318e93c7c71');
  return chooseStudioImageResource();
}

async function openResources() {
  try {
    const { openStudioResourceManager } = await import('./resource-manager.js?v=9ad29318e93c7c71');
