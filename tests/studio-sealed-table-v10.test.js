...
test('Studio Ready Window builds use the stable current facade for Native GUI IR 1.4 and payload v14', () => {
...
test('Studio site and offline PWA cache contain current v14 plus frozen compatibility modules without retired v07-v11 copies', () => {
  ...
  assert.ok(siteBuilder.includes("'sealed-native-gui-v14.js'"), 'site builder missing current v14 implementation sealer');
});

test('sealed native package helpers route payload v14 and frozen v12 through live facades', () => {
...
test('Pages waits for current Chrome v1.5 and frozen runtime lines without retired v07-v11 sealed workflows', () => {
