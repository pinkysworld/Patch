...
try {
  ...
  console.log('  assurance: Lean re-evaluates inter-recipe variable arguments, checks exact positional parameter binding, and connects the concrete values through beta.25 abstract intervals to declared callee intervals.');
