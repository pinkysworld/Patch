...
requireAll('current native facade', current, [
  "PATCH_CURRENT_NATIVE_CONTRACT_ID = 'native-gui-1.9/payload-19/runtime-1.10'",
  "PATCH_CURRENT_NATIVE_RUNTIME_VERSION = '1.10'",
  'PATCH_CURRENT_NATIVE_GUI_IR_VERSION = PATCH_NATIVE_GUI_IR_V19_VERSION',
  'PATCH_CURRENT_NATIVE_PAYLOAD_VERSION = PATCH_SEALED_NATIVE_GUI_WINDOW_ICON_VERSION',
  "windows: 'native-win32-runtime-v1.10'",
  "macos: 'native-macos-runtime-v1.10'",
  "linux: 'native-linux-runtime-v1.10'",
  'buildCurrentNativeGuiIR','sealCurrentNativeGuiRuntime','currentNativeHasButtonImage','currentNativeHasWindowIcon'
]);
...
const ir18 = read('src/native-gui-ir-v18.js');
requireAll('Native GUI IR 1.8', ir18, ["PATCH_NATIVE_GUI_IR_V18_VERSION = '1.8'",'buildNativeGuiIRV18','hasNativeButtonImage']);
const ir19 = read('src/native-gui-ir-v19.js');
requireAll('Native GUI IR 1.9', ir19, ["PATCH_NATIVE_GUI_IR_V19_VERSION = '1.9'",'buildNativeGuiIRV19','hasNativeWindowIcon']);
const sealed19 = read('src/sealed-native-gui-v19.js');
requireAll('sealed native payload v19', sealed19, ['sealNativeGuiRuntimeV19','PATCH_SEALED_NATIVE_GUI_WINDOW_ICON_VERSION','WICO']);
...
requireAll('offline compiler v0.2 workflow', offline, [
  ...
  'native-win32-runtime-v1.10','native-macos-runtime-v1.10','native-linux-runtime-v1.10',
  '--gui-runtime-v19','payload v19','--gui-payload-version 17','offline-compiler-v0.2','Patch Offline Compiler v0.2'
]);
...
requireAll('beta36 site build normalization', siteBuild, [
  ...
  'normalizeCurrentProductSurface','0.2 beta.36+','Native GUI IR 1.9 / payload v19 / runtime v1.10',
  'native-win32-runtime-v1.10','native-gui-ir-v19.js','sealed-native-gui-v19.js','native-window-icon-package-v110.js'
]);
...
requireAll('beta36 milestone', beta36, [
  'Patch 0.2.0-beta.36','Native GUI IR: `1.9`','sealed payload: `v19`','desktop runtime: `v1.10`','offline compiler line: `offline-compiler-v0.2`',
...
requireAll('Pages current runtime acquisition', pages, ['native-win32-runtime-v1.10','native-macos-runtime-v1.10','native-linux-runtime-v1.10','native-gui-ir-v19.js']);
rejectAll('Pages current runtime acquisition', pages, ['WIN32_RUNTIME_TAG: native-win32-runtime-v1.8','LINUX_NATIVE_RUNTIME_TAG: native-linux-runtime-v1.8','MACOS_NATIVE_RUNTIME_TAG: native-macos-runtime-v1.8']);

console.log('Patch project surface is coherent for beta.36 / IR 1.9 / payload v19 / runtime v1.10 / offline compiler v0.2.');
