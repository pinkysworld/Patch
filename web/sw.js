...
const CORE = [
  ...
  './playground.js', './beta35-studio.js', './studio-outline.js', './forms-designer.js', './designer-selection.js', './designer-core-selection.js', './slider-stage1.js', './table-stage1.js', './tree-designer.js', './designer-workspace.js', './designer-data-editor.js', './designer-structural-keyboard.js', './designer-tabs-nested.js', './designer-tabs-control-model.js', './designer-tabs-control-actions.js', './designer-tabs-page-model.js', './designer-tabs-page-duplicate.js', './designer-control-duplicate-model.js', './designer-control-duplicate.js', './designer-z-order-model.js', './designer-form-duplicate-model.js', './designer-form-duplicate.js', './designer-form-delete-model.js', './designer-form-delete.js', './designer-structure-ux.js', './designer-ux.js', './designer-event-inspector.js', './designer-layout-actions.js', './designer-table-model.js', './designer-table-actions.js', './designer-tree-model.js', './designer-tree-duplicate.js', './designer-toolbox.js', './form-designer-workflow.js', './designer-alignment.js', './designer-alignment-guides.js', './designer-multiselect.js', './designer-layout-policy.js', './designer-responsive-layout.js', './form-window-resize.js', './studio-dom-sync.js', './studio-diagnostics.js', './studio-quick-open.js', './studio-command-palette.js', './studio-accessibility.js', './manifest.webmanifest', './icon.svg',
