...
const SITE_SRC_FILES = [
  'interpreter.js','parser.js','picture-control.js','picture-source.js','button-image.js','window-icon.js','shape-control.js','shape-source.js','paintbox-control.js','imagelist-control.js','tree-node-presentation.js','listview-control.js','expression.js','change.js','change-analysis.js','range-analysis.js',
...
const SITE_WEB_MODULE_FILES = [
  'studio-bootstrap.js','runtime-integrity.js','native-build.js','project-lifecycle.js','project-config-restore.js','studio-showcase-project.js','recovery-manager.js',
