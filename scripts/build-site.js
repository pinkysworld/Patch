...
const SITE_SRC_FILES = [
  'interpreter.js','parser.js','picture-control.js','picture-source.js','button-image.js','window-icon.js','shape-control.js','shape-source.js','paintbox-control.js','imagelist-control.js','tree-node-presentation.js','expression.js','change.js','change-analysis.js','range-analysis.js',
  ...
  'c99.js','webapp.js','window-webapp.js','window-web-accessibility.js','window-web-paintbox.js','window-web-splitcontainer.js','window-build.js','menu-shortcut.js','window-events.js','designer.js','designer-shape.js','designer-paintbox.js','component-registry.js','designer-menu.js','designer-panel.js','designer-data.js','designer-tabs-nested.js','form-layout.js','window-layout-policy.js','panel-scroll.js','panel-split.js','input-presentation.js','window-input-presentation.js','table-column-presentation.js','button-presentation.js','studio-project.js','studio-resources.js','studio-resource-picture-placement.js','studio-outline-model.js','studio-diagnostics.js','studio-design-model.js','studio-design-cache.js','studio-form-materialization.js',
  'window-compiled.js','native-gui-ir-v12.js','native-gui-ir-v13.js','native-gui-ir-v14.js','native-gui-ir-v15.js','native-gui-ir-v16.js','native-gui-ir-v17.js','native-gui-ir-v18.js','native-gui-ir-v19.js','native-current-contract.js','native-picture-format-policy.js','native-picture-resources.js','native-frozen-contract.js','native-gui-frozen-lower.js','native-gui-frozen-seal.js','native-tree-backend-adapter.js','native-slider-backend-adapter.js','native-chrome-backend-adapter.js','native-shape-backend-adapter.js','native-paintbox-backend-adapter.js','native-paintbox-image-backend-adapter.js','native-button-image-backend-adapter.js','native-window-icon-backend-adapter.js','sealed-native-gui-v12.js','sealed-native-gui-v13.js','sealed-native-gui-v14.js','sealed-native-gui-v15.js','sealed-native-gui-v16.js','sealed-native-gui-v17.js','sealed-native-gui-v18.js','sealed-native-gui-v19.js','native-window-icon-packaging.js','windows-pe-icon-v110.js','native-window-icon-package-v110.js','sealed-native-package.js','prebuilt-native.js','prebuilt-window.js','local-native-kit.js',
...
const SITE_WEB_MODULE_FILES = [
  'studio-bootstrap.js','runtime-integrity.js','native-build.js','project-lifecycle.js','project-config-restore.js','studio-showcase-project.js','workshop-desk-project.js','recovery-manager.js',
  'playground.js','studio-build-controller.js','studio-run-controller.js','studio-window-renderer.js','studio-design-snapshots.js','studio-runtime-selection-state.js','studio-runtime-render-policy.js','forms-designer.js','designer-selection.js','designer-core-selection.js','slider-stage1.js','table-stage1.js','tree-designer.js','designer-workspace.js','designer-paintbox.js','resource-manager.js','designer-data-editor.js','designer-structural-keyboard.js','designer-tabs-nested.js','designer-structure-ux.js','designer-ux.js','designer-event-inspector.js','designer-focus-order.js','designer-menu-designer.js','designer-panel.js','designer-splitcontainer.js','designer-ui-namespace.js','designer-toolbox.js','designer-imagelist.js','designer-statusbar.js','form-designer-workflow.js','designer-alignment.js','designer-alignment-guides.js','form-window-resize.js',
...
SITE_WEB_MODULE_FILES.splice(SITE_WEB_MODULE_FILES.indexOf('designer-layout-actions.js') + 1, 0,
  ...
  'designer-control-clipboard-model.js', 'designer-control-clipboard-guard.js',
...
function normalizeCurrentProductSurface(name, source) {
  ...
  if (name !== 'downloads.html') {
    html = html
      ...
      .replaceAll('Native GUI IR 1.7 / payload v17 / runtime v1.8', 'Native GUI IR 1.9 / payload v19 / runtime v1.10')
      .replaceAll('Native GUI IR <strong>1.7</strong>', 'Native GUI IR <strong>1.9</strong>')
      .replaceAll('payload <strong>v17</strong>', 'payload <strong>v19</strong>')
      .replaceAll('runtime <strong>v1.8</strong>', 'runtime <strong>v1.10</strong>')
      .replaceAll('Native GUI IR 1.7 as payload v17', 'Native GUI IR 1.9 as payload v19')
      .replaceAll('current runtime v1.8 templates', 'current runtime v1.10 templates')
      .replaceAll('Current runtime v1.8 templates', 'Current runtime v1.10 templates')
      .replaceAll('IR 1.7 / v1.8', 'IR 1.9 / v1.10')
      .replaceAll('native-win32-runtime-v1.8', 'native-win32-runtime-v1.10')
      .replaceAll('native-macos-runtime-v1.8', 'native-macos-runtime-v1.10')
      .replaceAll('native-linux-runtime-v1.8', 'native-linux-runtime-v1.10');
  }
...
function normalizeCurrentNativeBuildCopy(source) {
  return source
    ...
    .replaceAll('Native GUI IR 1.7', 'Native GUI IR 1.9')
    .replaceAll('payload v17', 'payload v19')
    .replaceAll('runtime v1.8', 'runtime v1.10');
}
