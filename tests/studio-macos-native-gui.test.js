...
test('browser package seals current Native GUI IR 1.9 payload v19 into a minimal macOS app bundle ZIP', () => {
...
test('Studio defaults macOS Window downloads to native AppKit runtime v1.10 sealing without token', () => {
