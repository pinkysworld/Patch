...
requireAll('Studio beta36 shell', index, [
  ...
  'multi-file project bundle v4','source-backed Designer','Native GUI IR 1.6','payload v16','runtime v1.7',
  'IR 1.6 / v1.7','id="editorTabs"','id="editorParseStatus"','id="openCommandPalette"',
...
requireAll('Current native product facade', current, [
  "native-gui-1.6/payload-16/runtime-1.7","PATCH_CURRENT_NATIVE_GUI_IR_VERSION = PATCH_NATIVE_GUI_IR_V16_VERSION",
  'PATCH_CURRENT_NATIVE_PAYLOAD_VERSION = PATCH_SEALED_NATIVE_GUI_PAINTBOX_VERSION',"PATCH_CURRENT_NATIVE_RUNTIME_VERSION = '1.7'",
...
requireAll('Downloads beta36', downloads, [
  ...
  'Native GUI IR <strong>1.6</strong>','payload <strong>v16</strong>','runtime <strong>v1.7</strong>',
  'offline-compiler-v0.2','native-win32-runtime-v1.7','native-macos-runtime-v1.7','native-linux-runtime-v1.7','runtime-manifest.json',
...
console.log('Patch public site validation passed for beta.36 / project bundle v4 / Native GUI IR 1.6 / payload v16 / runtime v1.7 / RAD Object Inspector, Component Palette and Focus Order Stage 1; research paper remains repository-only.');
