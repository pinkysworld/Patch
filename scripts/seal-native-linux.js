...
if (rawPayloadVersion == null || rawPayloadVersion === '' || (payloadVersion !== 7 && payloadVersion !== 8)) {
  console.error('scripts/seal-native-linux.js is the historical payload-v7/v8 sealer, not the Ready runtime.');
...
const sealed = payloadVersion >= 11
  ? sealNativeGuiRuntimeV11(runtime, gui, { platform: 'linux' })
  : sealNativeGuiRuntime(runtime, gui, { platform: 'linux', version: payloadVersion });
