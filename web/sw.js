...
const CORE = [
  ...
  './playground.js', './forms-designer.js', './designer-alignment.js', './designer-alignment-guides.js', './designer-multiselect.js', './designer-layout-policy.js', './designer-responsive-layout.js', './form-window-resize.js', './native-build.js', './project-lifecycle.js', './project-config-restore.js', './recovery-manager.js', './studio-diagnostics.js', './studio-accessibility.js', './manifest.webmanifest', './icon.svg',
  ...
  '../src/wasm-direct.js', '../src/c99.js', '../src/webapp.js', '../src/window-webapp.js', '../src/window-web-accessibility.js', '../src/window-build.js', '../src/window-events.js', '../src/designer.js', '../src/form-layout.js', '../src/window-layout-policy.js', '../src/studio-project.js', '../src/studio-diagnostics.js', '../src/window-compiled.js', '../src/native-gui-ir.js', '../src/sealed-native-gui.js',
