...
Frozen Native GUI IR 1.4 remains fail-closed for Shape source. PaintBox Stage 1 clear/line/rectangle/ellipse/text is native on Native GUI IR 1.6 / payload v16 / runtime v1.7. PaintBox `draw image` is native on Native GUI IR 1.7 / payload v17 / runtime v1.8. ImageList Button images are native on the current Native GUI IR 1.8 / payload v18 / runtime v1.9 line.
