...
const CORE = [
  ...
  './playground.js', './beta35-studio.js', './studio-outline.js', './forms-designer.js', './designer-selection.js', './designer-core-selection.js', './slider-stage1.js', './table-stage1.js', './tree-designer.js', './designer-workspace.js', './designer-data-editor.js', './designer-structural-keyboard.js', './designer-tabs-nested.js', './designer-tabs-control-model.js', './designer-tabs-control-actions.js', './designer-tabs-page-model.js', './designer-tabs-page-duplicate.js', './designer-control-duplicate-model.js', './designer-control-duplicate.js', './designer-z-order-model.js', './designer-form-duplicate-model.js', './designer-form-duplicate.js', './designer-form-delete-model.js', './designer-form-delete.js', './designer-structure-ux.js', './designer-ux.js', './designer-layout-actions.js', './designer-table-model.js', './designer-table-actions.js', './designer-tree-model.js', './designer-tree-duplicate.js', './designer-toolbox.js', './form-designer-workflow.js', './designer-alignment.js', './designer-alignment-guides.js', './designer-multiselect.js', './designer-layout-policy.js', './designer-responsive-layout.js', './form-window-resize.js', './studio-dom-sync.js', './studio-diagnostics.js', './studio-quick-open.js', './studio-command-palette.js', './studio-accessibility.js', './manifest.webmanifest', './icon.svg',
  ...
  '../src/wasm-direct.js', '../src/c99.js', '../src/webapp.js', '../src/window-webapp.js', '../src/window-web-accessibility.js', '../src/window-build.js', '../src/menu-shortcut.js', '../src/window-events.js', '../src/designer.js', '../src/designer-data.js', '../src/designer-tabs-nested.js', '../src/form-layout.js', '../src/window-layout-policy.js', '../src/studio-project.js', '../src/studio-outline-model.js', '../src/studio-diagnostics.js', '../src/window-compiled.js', '../src/native-gui-ir-v12.js', '../src/native-gui-ir-v13.js', '../src/native-current-contract.js', '../src/native-frozen-contract.js', '../src/native-gui-frozen-lower.js', '../src/native-gui-frozen-seal.js', '../src/native-tree-backend-adapter.js', '../src/native-slider-backend-adapter.js', '../src/sealed-native-gui-v12.js', '../src/sealed-native-gui-v13.js',
