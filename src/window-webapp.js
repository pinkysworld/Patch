...
export function buildStandaloneWindowWebApp(compiled, name) {
  ...
  const support = validateWindowRuntimeSupport(compiled, { allowTree: true, allowTreeNodeImages: true, allowTreeNodeHints: true, allowSlider: true, allowProgressBar: true, allowScrollBar: true, allowAdvancedTableColumns: true, allowMemo: true, allowPaintBox: true, allowImageList: true });
