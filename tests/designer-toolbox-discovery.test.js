...
test('desktop Designer rail gives graphics Chrome and Timer stable source-backed slots', () => {
  ...
  assert.match(workspace, /#designer #addShape \{ top: 491px; \}/);
  assert.match(toolboxCss, /#designer #addPaintbox \{ top: 525px !important; \}/);
  assert.match(toolboxCss, /#designer #addPaintbox::before \{ content: "▦"; \}/);
  assert.match(toolboxCss, /#designer #addStatusbar \{ top: 559px !important; \}/);
