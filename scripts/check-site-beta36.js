...
requireAll('beta36 Studio', index, [
  'data-patch-version="0.2.0-beta.36"','0.2 beta.36+','Native GUI IR 1.8','payload v18','runtime v1.9',
...
requireAll('beta36 current native facade', current, [
  "native-gui-1.8/payload-18/runtime-1.9","PATCH_CURRENT_NATIVE_RUNTIME_VERSION = '1.9'",
  'native-win32-runtime-v1.9','native-macos-runtime-v1.9','native-linux-runtime-v1.9'
]);

requireAll('beta36 downloads', downloads, [
  'offline-compiler-v0.2','Native GUI IR <strong>1.8</strong>','payload <strong>v18</strong>','runtime <strong>v1.9</strong>'
]);
rejectAll('beta36 downloads', downloads, ['offline-compiler-v0.1','href="https://github.com/pinkysworld/Patch/releases/tag/native-win32-runtime-v1.8"']);
