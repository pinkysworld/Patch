import { addDesignerControl, listDesignerControls, updateDesignerControl } from './src/designer.js?v=868f0784ca7f3972';
import { normalizeImageListItemName } from './src/imagelist-control.js?v=868f0784ca7f3972';
import { studioResourceSourceExpression } from './src/studio-resources.js?v=868f0784ca7f3972';
import {
...
async function chooseResource() {
  const { chooseStudioImageResource } = await import('./resource-manager.js?v=868f0784ca7f3972');
  return chooseStudioImageResource();
}

async function openResources() {
  try {
    const { openStudioResourceManager } = await import('./resource-manager.js?v=868f0784ca7f3972');
