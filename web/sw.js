...
const CORE = [
  ...
  './playground.js', './beta35-studio.js', './studio-outline.js', './forms-designer.js', './designer-selection.js', './designer-core-selection.js', './table-stage1.js', './tree-designer.js', './designer-workspace.js', './designer-data-editor.js', './designer-structural-keyboard.js', './designer-tabs-nested.js', './designer-structure-ux.js', './designer-ux.js', './designer-layout-actions.js', './designer-toolbox.js', './form-designer-workflow.js', './designer-alignment.js', './designer-alignment-guides.js', './designer-multiselect.js', './designer-layout-policy.js', './designer-responsive-layout.js', './form-window-resize.js', './studio-dom-sync.js', './studio-diagnostics.js', './studio-accessibility.js', './manifest.webmanifest', './icon.svg',
