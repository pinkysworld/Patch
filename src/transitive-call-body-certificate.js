...
/** Generate Lean evidence for beta.30 finite transitive exact call trees. */
export function generateTransitiveCallBodyCertificate(source, options = {}) {
  ...
  return {
    ...
    certified,
    artifact,
    certificateVersion: PATCH_TRANSITIVE_CALL_BODY_CERTIFICATE_VERSION
  };
}
