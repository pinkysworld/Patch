...
requireAll('Site build browser graph', buildSite, [
  ...
  'independent-range-expression.js','independent-guard-expression.js','native-current-contract.js','native-frozen-contract.js','native-gui-ir-v13.js','native-gui-ir-v14.js','native-gui-ir-v15.js','native-gui-ir-v16.js','native-gui-ir-v17.js',
  'sealed-native-gui-v13.js','sealed-native-gui-v14.js','sealed-native-gui-v15.js','sealed-native-gui-v16.js','sealed-native-gui-v17.js','native-chrome-backend-adapter.js','native-shape-backend-adapter.js','native-paintbox-backend-adapter.js','native-paintbox-image-backend-adapter.js'
]);
...
requireAll('Service worker graph and fallback', sw, [
  ...
  './src/native-current-contract.js','./src/native-frozen-contract.js','./src/native-gui-ir-v13.js','./src/native-gui-ir-v14.js','./src/native-gui-ir-v15.js','./src/native-gui-ir-v16.js','./src/native-gui-ir-v17.js','./src/sealed-native-gui-v13.js','./src/sealed-native-gui-v14.js','./src/sealed-native-gui-v15.js','./src/sealed-native-gui-v16.js','./src/sealed-native-gui-v17.js',
  './src/native-chrome-backend-adapter.js','./src/native-shape-backend-adapter.js','./src/native-paintbox-backend-adapter.js','./src/native-paintbox-image-backend-adapter.js',"const navigation = event.request.mode === 'navigate'",'throw error'
]);
