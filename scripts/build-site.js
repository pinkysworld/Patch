...
for (const name of ['index.html', 'style.css', 'designer-inspector.css', 'forms-designer.css', 'project-lifecycle.css', 'studio-diagnostics.css', 'manifest.webmanifest', 'icon.svg']) {
  fs.copyFileSync(path.join(sourceWeb, name), path.join(out, name));
}

for (const name of ['playground.js', 'forms-designer.js', 'native-build.js', 'project-lifecycle.js', 'studio-diagnostics.js', 'sw.js']) {
