...
test('browser package seals Native GUI IR v0.4 into a minimal macOS app bundle ZIP', () => {
...
test('macOS native runtime workflow smokes Tabs and publishes universal AppKit runtime v0.4', () => {
  for (const marker of [
  ...
  assert.equal(workflow.includes('native-macos-runtime-v0.3'), false);
