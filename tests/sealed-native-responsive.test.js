...
test('Pages and offline compiler use current runtime v1.2 while frozen responsive v0.9 stays separate', () => {
  for (const tag of ['native-win32-runtime-v1.2','native-macos-runtime-v1.2','native-linux-runtime-v1.2']) {
  ...
  for (const runtimeSource of [
    'native-runtime\\win32-sealed-gui-v12.cpp',
    'native-runtime/appkit-sealed-gui-v12.mm',
    'native-runtime/gtk-sealed-gui-v12.cpp'
  ...
  assert.match(offline, /payload v11\/runtime v1\.2/);
